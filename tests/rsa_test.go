...
func TestRSA(t *testing.T) {
	...
	fmt.Println("PRIVATE KEY LEN:", len(privateKeyPem))
	...
	if err != nil {
		t.Fatalf("Error generating private key from string: %v", err)
	}
